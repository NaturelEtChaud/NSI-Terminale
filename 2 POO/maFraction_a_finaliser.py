...
class Fraction :
    ...
    def a_la_puissance(self, exposant):
        '''
    ...
    def est_plus_grande_que(self, autre) :
        '''
    ...
    def est_strictement_plus_grande_que(self, autre) :
        '''
    ...
    def est_plus_petite_que(self, autre) :
        '''
    ...
    def est_strictement_plus_petite_que(self, autre) :
        '''
